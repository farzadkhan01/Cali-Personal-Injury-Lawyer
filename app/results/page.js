...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      'A framework for verified case results, structured for real outcomes as they become available.',
    url: '/results',
  },
};
...
const resultSlots = [
  {
    ...
    note: 'Verified result will be added here once available.',
    stat: '$2,850,000',
  },
  {
        ...
        <Container size='narrow'>
          ...
          <Reveal delay={0.2}>
            <p className='mt-6 max-w-2xl text-lg leading-relaxed text-gray-600'>
              No case results have been verified for this concept practice yet.
              This page is structured so real, confirmed outcomes can be added
              here without redesigning the layout.
            </p>
          </Reveal>
        </Container>
      </Section>
      ...
      <Section spacing='tight'>
        <Container size='narrow'>
          ...
          <p className='mt-6 text-base leading-relaxed text-gray-600'>
            ...
            including the severity of the injury, the strength of the evidence,
            and the willingness of the responsible party to negotiate fairly.
            Because of this, past outcomes are not a guarantee of future
            results. Verified case results will be published here once
            available, structured so each one reflects the specific facts
            involved.
          </p>
        </Container>
      </Section>
