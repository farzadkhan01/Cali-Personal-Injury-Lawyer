...
export const metadata = {
  title: 'Testimonials',
  description:
    'Illustrative examples of the client experience Cali Personal Injury Lawyer is designed around.',
  alternates: { canonical: '/testimonials' },
  openGraph: {
    title: `Testimonials | ${siteConfig.name}`,
    description:
      'Illustrative examples of the client experience this practice is designed around.',
    url: '/testimonials',
  },
};
        ...
        <Container size='narrow'>
          ...
          <Reveal delay={0.2}>
            <p className='mt-6 max-w-2xl text-lg leading-relaxed text-gray-600'>
              The quotes below are illustrative examples, not statements from
              real clients. They describe the standard of communication and care
              this practice is built around, and will be replaced with genuine
