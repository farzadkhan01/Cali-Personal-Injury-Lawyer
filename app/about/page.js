...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      'The philosophy behind Cali Personal Injury Lawyer and how the firm approaches every case.',
    url: '/about',
  },
};
...
const values = [
  ...
  },
  {
    ...
    title: 'Preparation',
    description:
      'Every conversation is a chance to understand your situation a little better.',
  },
  {
    icon: ShieldCheck,
    title: 'Accountability',
    description:
      'We hold ourselves to the same standard we hold the other side to.',
  },
  {
    icon: HeartHandshake,
    title: 'Patience',
    description:
      'Recovery does not follow a schedule, and neither does our support.',
  },
];
      ...
      <Section
        ...
        <Container size='narrow'>
          ...
          <TextReveal
            ...
            People come to us after everything got harder. We try to make what
            happens next easier.
          </TextReveal>
          <Reveal delay={0.2}>
            <p className='mt-6 max-w-2xl text-lg leading-relaxed text-gray-600'>
              Cali Personal Injury Lawyer was built around a simple belief:
              after an accident, people need clarity as much as they need
              advocacy. Here is how we think about the work.
            </p>
          </Reveal>
        </Container>
      </Section>
          ...
          <div className='grid gap-16 lg:grid-cols-2 lg:items-center'>
            <Reveal>
              <ImageFrame
                ...
                rounded='4xl'
                className='relative'>
                <div className='absolute inset-0 bg-linear-to-br from-accent-500 via-ink-950 to-trust-700' />
            ...
            <div className='flex flex-col gap-8'>
              ...
              <p className='text-base leading-relaxed text-gray-600'>
                Most people do not plan for the moment their life gets
                interrupted. An accident does not just cause injury, it
                introduces a list of unfamiliar decisions, deadlines, and
                conversations, often while you are still recovering.
              </p>
              <p className='text-base leading-relaxed text-gray-600'>
                We built this practice around closing that gap. Not by promising
                outcomes we cannot control, but by making sure you always
                understand where things stand, what is happening next, and why.
              </p>
              <blockquote className='border-l-2 border-accent-500 pl-6 font-display text-2xl italic leading-snug text-ink-950'>
                Advocacy without clarity just adds to the confusion. We try to
                offer both.
              </blockquote>
            </div>
          </div>
        ...
        <Container>
          ...
          <Reveal delay={0.05}>
            <GlassCard
              tone='light'
              blur='soft'
              className='grid gap-8 p-8 sm:grid-cols-2 sm:p-10 lg:p-12'>
