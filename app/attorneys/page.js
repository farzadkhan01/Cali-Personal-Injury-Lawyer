...
export const metadata = {
  title: 'Attorneys',
  description:
    'Meet the team behind Cali Personal Injury Lawyer and the philosophy that shapes how cases are handled.',
        ...
        <Container size='narrow'>
          ...
          <Reveal delay={0.2}>
            <p className='mt-6 max-w-2xl text-lg leading-relaxed text-gray-600'>
              This section is structured to introduce the attorneys handling
              your case, including their focus, background, and approach, once
              verified information is finalized.
            </p>
          </Reveal>
        </Container>
      </Section>
