...
const pillars = [
  {
    icon: Shield,
    title: "Advocacy",
    description: "We treat every case as if it were the only one that mattered, because to you, it is.",
  },
  {
    icon: Compass,
    title: "Clarity",
    description: "Plain explanations and honest timelines, without legal jargon you have to decode alone.",
  },
  {
    icon: HeartHandshake,
    title: "Human Support",
          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-8">
              {pillars.map(({ icon: Icon, title, description }, index) => (
                <Reveal key={title} delay={index * 0.1} className="flex gap-5">
