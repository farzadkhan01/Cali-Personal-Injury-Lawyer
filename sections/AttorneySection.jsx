        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            ...
            <dl className="grid gap-4 sm:grid-cols-2">
              {attorney.credentials.map((item) => (
                <div key={item.label} className="flex flex-col gap-1">
                  <dt className="text-xs font-medium uppercase tracking-[0.14em] text-gray-400">{item.label}</dt>
          ...
          <Reveal className="lg:order-2">
            <ImageFrame ratio="4 / 5" rounded="4xl" className="relative">
              ...
              <GlassCard tone="light" blur="soft" className="absolute bottom-6 left-6 right-6 flex flex-col gap-0.5 p-4">
                <span className="font-display text-base text-ink-950">{attorney.name}</span>
